...
from .helpers import get_icon_upload_path
...
class EquipmentType(models.Model):
    ...
    base_type = models.CharField(
        help_text=_("Equipment base type"), choices=wg_enumeration.BaseEquipmentTypes, 
        default=wg_enumeration.BaseEquipmentTypes.CUPBOARD, blank=False, null=False,
        db_column="EqType_Base_Type")
...
class Product(models.Model):
    ...
    category = models.IntegerField(
        choices=wg_enumeration.ProductCategories, blank=False, 
...
class StockItem(models.Model):
    product = models.ForeignKey(Product, blank=False, null=False, db_column="StkItem_Prod", db_index=True)
...
class Recipe(models.Model):
    ...
    items = models.ManyToManyField(Product, through="RecipeProduct", blank=False, null=False, db_column="Rcp_Item")
...
class CookingPlan(models.Model):
    ...
    meal = models.IntegerField(
        choices=wg_enumeration.Meals, blank=False, null=False, 
...
class ConversionRule(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE, blank=False, null=False, db_column="ConvRule_Prod")
    from_unit = models.IntegerField(choices=wg_enumeration.Units, blank=False, null=False, db_column="ConvRule_From_Unit")
    to_unit = models.IntegerField(choices=wg_enumeration.Units, blank=False, null=False, db_column="ConvRule_To_Unit")
...
class Config(models.Model):
    ...
    default_expired_action = models.IntegerField(
        choices=wg_enumeration.EXPIRED_ACTIONS, blank=False, null=False, 
