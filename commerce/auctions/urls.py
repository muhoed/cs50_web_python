...
urlpatterns = [
	...
	path("password_reset", 
			auth_views.PasswordResetView.as_view(template_name="auctions/auth/password_reset_form.html",
			email_template_name="auctions/auth/emails/password_reset_email.html",
			subject_template_name="auctions/auth/emails/password_reset_subject.txt", success_url=reverse_lazy("auctions:password_reset_done")), 
			name='password_reset'),
