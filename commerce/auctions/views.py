...
def get_message_content(request, uid, topic=None, start=None, end=None):
    """
    Simple function-based view to retrieve a content of email message files generated by Django file email backend.
    Assumes that a path to files is stored in EMAIL_FILE_PATH variable in settings.py and filename format is '[uid]-[topic]=[timestamp].log'."""
