...
def product_handler(sender, instance, **kwargs):
    ...
    content = _("The product '%(prod)s' was added.\nGo to the <a href='%(url)s'>\
...
def listing_handler(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        content = _("Listing was created. Details: %(listing)s.\nClick <a href=\
        '%(url)s'>here</a> to manage listing.\nThis message is autogenerated. \
        Do not reply.") % {
                'listing': instance, 
                'url': instance.get_absolute_url()
                }
        ...
        \nThe user %(user)s placed the highest bid up now and is the listing winner.\
        \nYou can contact the winner through the 'Contact buyer' button on <a href=\
        '%(url)s'>the listing page</a> or directly by email %(email)s.\nPlease make \
        sure you ship the product to the winner at her/his delivery address:%(address)s.\
        \nThis message is autogenerated. Do not reply.") %\
                    {
        ...
        shall be sent to the buyer's delivery address at %(address)s. Please make \
        ...
        </a>. You can also contact the seller directly by email %(email)s.\nThis \
        message is autogenerated. Do not reply.") %\
                    {
                    'prod': instance.product.name, 
                    'url': instance.get_absolute_url(), 
        ...
        content = _("The buyer marked the listing for %(prod)s as 'Delivered'.\nThis \
        message is autogenerated. Do not reply.") %\
                    {
                        'prod': instance.product.name
                    }
        ...
        details at <a href='%(url)s'>the listing page</a>.\nThis message is \
...
def answer_handler(sender, instance, **kwargs):
    ...
    listing.\nText of your initial comment:\n%(comment)s\nAnswered by %(respondent)s\
     on %(time)s.\nAnswer's content:\n%(answer)s\nGo to <a href='%(url)s'>here</a> to \
     see listing details.\nThis message is autogenerated. Do not reply.") %\
                            {
...
def pre_bid_handler(sender, instance, **kwargs):
    if float(instance.value) <= float(instance.listing.max_bid):
        #messages.failure = (request, f"Your bid is less or equal to the current highest bid. Please increase a bid value and try again. Current highest bid is %s" % str(instance.listing.max_bid))
        return HttpResponse(f"Your bid is less or equal to the current highest bid. Please increase a bid value and try again. Current highest bid is %s" % str(instance.listing.max_bid))
...
def bid_handler(sender, instance, **kwargs):
    ...
    content1 = _("You have placed a new bid on the following listing:%(listing)s. Bid amount: %(amount)s€, Bid time: %(time)s. Go to <a href='%(url)s'>listing \
    page</a> to see details. This message is autogenerated. Do not reply.") % \
                {
    ...
    content2 = _("A bid was placed in your listing for %(prod)s.\nBidder: %(bidder)\
